...
#include "stanExports_lewontin_cohen_univariate.h"

RCPP_MODULE(stan_fit4lewontin_cohen_univariate_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lewontin_cohen_univariate")
